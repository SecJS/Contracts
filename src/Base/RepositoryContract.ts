...
export interface RepositoryContract {
  ...
  getAll(pagination?: PaginationContract, options?: ApiRequestContract): Promise<PaginatedResponse<any>>
  storeOne(body: any): Promise<any>
  getOne(id: string | number | any, options?: ApiRequestContract): Promise<any | undefined>
